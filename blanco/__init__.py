...
Division.OPEN = Division("Open")
Division.SPECIAL = Division("SPECIAL")

DIVISIONS = [ Division._12_AND_UNDER, Division._13_AND_OVER,
              Division.ADULT, Division.OPEN ]
...
Level._1ST = Level("1st", ["1", "2", "3"])
Level._2ND = Level("2nd", ["1", "2", "3"])
Level._3RD = Level("3rd", ["1", "2", "3"])
Level._4RTH = Level("4rth", ["1", "2", "3"])
Level.INTRO = Level("Intro", ["A", "B", "C"])
Level.PRIX_ST_GEORGES = Level("Prix St. Georges", ["PSG"])  #empty
Level.TRAINING = Level("Training", ["1", "2", "3"])
